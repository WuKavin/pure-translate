...
const DOMAIN_RULES = [
  ...
  { test: /(^|\.)arxiv\.org$|(^|\.)(?:edu(?:\.[a-z]{2})?|ac\.[a-z]{2})$|(^|\.)nature\.com$|(^|\.)science\.org$|(^|\.)springer\.com$|(^|\.)ieee\.org$|(^|\.)acm\.org$|(^|\.)sciencedirect\.com$|(^|\.)semanticscholar\.org$|(^|\.)researchgate\.net$|(^|\.)biorxiv\.org$|(^|\.)medrxiv\.org$/, role: 'academic' },
